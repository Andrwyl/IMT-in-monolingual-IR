...
datasets_path = os.path.abspath(os.path.join(os.getcwd(), '../../shared_tokens/datasets'))
class TrainDataset(Dataset):
    def __init__(
        ...
        if run_filter:
            ...
            print("Training with Filtering")
            
            self.train_data = datasets.load_from_disk(f'{datasets_path}/{target_lang}-training-filtered')
...
class EncodeDataset(Dataset):
    ...
    def __init__(self, dataset: datasets.Dataset, tokenizer: PreTrainedTokenizer, target_lang: str, is_query: bool, run_filter: bool, max_len=128):
        ...
        if run_filter:
            ...
            self.encode_data = datasets.load_from_disk(f'{datasets_path}/{target_lang}-{tmp}encodings-filtered')
