...
class TevatronTrainingArguments(TrainingArguments):
    ...
    target_lang: str = field(default='hi', metadata={"help": "this is the language we are either training or encoding"})
    run_filter: bool = field(default=True, metadata={"help": "run shared token filtering before training or encoding"})
